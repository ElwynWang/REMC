...
float struct_dih_ang(struct vector r1, struct vector r2, struct vector r3, struct vector r4);
...
void get_rot(double obj_i[3], double obj_f[3], double tor1[3], double tor2[3], double tor3[3], double tor4_i[3], double tor_f[3]);
...
void get_rot(double obj_i[3], double obj_f[3], double tor1[3], double tor2[3], double tor3[3], double tor4_i[3], double tor4_f[3])
 {
